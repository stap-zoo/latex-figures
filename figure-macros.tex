...
\newcommand{\Mext}{\mathsf{M}_{\mathcal{E}}}    % external matrix
\newcommand{\Mint}{\mathsf{M}_{\mathcal{I}}}    % internal matrix
\newcommand{\Rf}{R_f}                           % number of initial/final full rounds
\newcommand{\RP}{R_P}                           % number of partial rounds
